...
<ResponseField name="meta" type="object" required>
  ...
  <Expandable title="properties">
    <ResponseField name="meta.version" type="string" required>
      The v2 contract version that served the response - currently `"2.7"`.
...
Twelve of the 62 v2 endpoints have full Pydantic response schemas in the
...
The other 50 endpoints are documented with examples and the same
envelope shape.
