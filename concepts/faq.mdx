...
Live GEX defaults to **`positioning=flow`**: dealer size is aggressor
sold minus bought from the multi-venue options tape, not textbook OI
sign. Walls and HVL can shift when flow rotates even if spot is quiet.
