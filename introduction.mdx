...
distributions, alongside price, open interest, funding, CVD, liquidations
and spot ETF flows. The same data that powers the BackQuant terminal is
available programmatically, ready to plug into your trading systems,
research workflows, and dashboards. It is also available over
[MCP](/mcp-server) for Claude and other AI clients.
...
| **Market data** | OHLCV candles with buy/sell split, aggregate open interest, funding, CVD on both perp and spot, liquidations over time, plus a bundle returning all of them on one shared time axis |
| **ETF flows** | Daily creations and redemptions per fund with running cumulatives, premium/discount to NAV, assets under management |
| **Cross-venue book** | Best bid and offer across every venue with the venue named on each side, spread and quote dispersion per contract |
