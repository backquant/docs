...
> Price against the dealer-gamma levels, perpetual positioning and the options
> tape, in one call. It names anything it could not fetch instead of quietly
> returning less.
> *(`get_brief`)*

> **"Anything worth knowing on ETH right now?"**
> *(`get_brief`)*

Reach for a specific tool once the question names a metric; `get_brief` is for
open questions.

## Perpetuals

> **"Is open interest building on BTC?"**
> *(`get_perps`, `view=oi`)*

> **"What is funding doing, are shorts paying longs?"**
> *(`get_perps`, `view=funding`)*

> **"Show me spot versus perp CVD."**
> Aggressor delta on both sides, which is where spot and perp demand diverge.
> *(`get_perps`, `view=cvd`)*

## Dealer positioning and levels
