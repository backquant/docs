---
title: "MCP server"
description: "Use BackQuant's crypto options, GEX and flow data directly inside Claude, Cursor or any MCP client. OAuth sign-in or an API key, 20 tools, no code required."
---
...
Twenty tools, grouped by what you would ask for. Each returns a shaped,
