...
description: "Channel-multiplexed live stream of options trades across all tape venues, with API-key auth, per-tier connection caps and slow-consumer protection."
---
