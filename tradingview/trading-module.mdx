...
description: "A modular overlay combining trend, impulse, stop loss, RSI screener, market structure, FVGs, order blocks and reversal bands for discretionary execution."
